...
async def get_assistant_reply(user_message: str, history: list[dict] | None = None) -> str:
    """
    ...
    return (
            f"Study note: {user_message[:80]}... "
            "This is a simulated answer. "
            "Practice: Can you explain it in your own words?"
        )      
